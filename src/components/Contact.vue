<template>
  ...
  <section id="section3"  class="mx-auto p-16 max-w-screen-xl md:rounded-md pb-16">
      ...
      <div class="col-span-4 bg-blue-900 px-8 py-10 text-gray-200 md:col-span-2 md:px-10 md:py-12 lg:col-span-1">
        ...
        <ul>
          ...
          <li class="my-6 flex items-center text-left">
            ...
            <div>
              <a class="cursor-pointer  text-base md:text-lg" href="#">@daffafznnn_</a>
          ...
          <li class="my-6 flex items-center text-left">
            ...
            <div>
              <p class=" text-base md:text-lg">daffafauzan</p>
              <span class="block text-xs uppercase">LinkedIn</span>
            </div>
          </li>
        </ul>
      </div>
      <div  class="order-first col-span-4 max-w-screen-md px-8 py-10 md:order-last md:col-span-2 md:px-10 md:py-12 bg-blue-900">
        <h2 class="mb-8 text-2xl font-black">Get in touch</h2>
        <p class="mt-2 mb-4 font-sans text-sm tracking-normal text-gray-200">Don't be shy to ask me a question.</p>
        <form action="">
          <div class="md:col-gap-4 mb-5 grid md:grid-cols-2">
            <input class="col-span-2 my-5 w-full border-b py-3 text-sm outline-none focus:border-b-2 focus:border-cyan-400 bg-blue-800 text-gray-200 placeholder:text-cyan-400 border-none rounded-lg" type="email" placeholder="Email" name="email" />
            <input class="col-span-2 w-full border-b py-3 text-sm outline-none focus:border-b-2 focus:border-cyan-400 bg-blue-800 text-gray-200 placeholder:text-cyan-400 border-none rounded-lg" type="text" placeholder="Name" name="name" />
          </div>
          <textarea class="mb-10 w-full resize-y whitespace-pre-wrap border-b py-3 text-sm outline-none focus:border-b-2 focus:border-cyan-400 bg-blue-800 text-gray-200 placeholder:text-cyan-400 border-none rounded-lg" id="" rows="6" placeholder="Question" name="question"></textarea>
          <button type="submit" class="group flex cursor-pointer items-center rounded-xl bg-blue-800 hover:border border-cyan-400 bg-none px-8 py-4 text-center font-semibold leading-tight text-white">
            Send
