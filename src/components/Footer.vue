<template>
  ...
  <div class="absolute -top-10 left-1/2 h-16 w-16 -translate-x-1/2 rounded-xl border-4 border-sky-500 bg-blue-900 p-2"><img class="h-full object-contain" src="../assets/logo-daffa-a219537a.png" alt="" /></div>
