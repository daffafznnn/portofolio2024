<template>
  ...
  <a href="#home" class="flex items-center whitespace-nowrap text-2xl font-black ml-10">
  ...
  <nav aria-label="Header Navigation" class="peer-checked:pt-8 peer-checked:max-h-60 flex max-h-0 w-full flex-col items-center overflow-hidden transition-all lg:ml-24 lg:max-h-full lg:flex-row">
    <ul class="flex w-full flex-col items-center space-y-2 lg:flex-row lg:justify-center lg:space-y-0">
      <li class="lg:mr-12"><a class="rounded  text-cyan-400 transition-all hover:text-cyan-300" href="#">Portofolio</a></li>
      <li class="lg:mr-12"><a class="rounded  text-cyan-400 transition-all hover:text-cyan-300" href="#section2">About</a></li>
      <li class="lg:mr-12"><a class="rounded  text-cyan-400 transition-all hover:text-cyan-300" href="#">Contact</a></li>
      <li class="lg:mr-12"><a class="rounded  text-cyan-400 transition-all hover:text-cyan-300" href="#">FAQ</a></li>
    </ul>
    <hr class="mt-4 w-full lg:hidden" />
    <div class="my-4 flex items-center space-x-6 space-y-2 lg:my-0 lg:ml-auto lg:space-x-8 lg:space-y-0">
      <a href="#" title="" class="whitespace-nowrap rounded-xl bg-blue-900 px-4 py-2 font-medium text-cyan-400 transition-all hover:ring ring-cyan-400 border-cyan-400 hover:scale-75">unduh cv</a>
    </div>
  </nav>
</header>
...
export default {
  ...
  methods: {
    handleScroll() {
      // Tambahkan logika di sini untuk menentukan apakah navbar harus berubah warna
      // Contoh: jika posisi scroll lebih dari 100 piksel, maka navbar berubah warna
