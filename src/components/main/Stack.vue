<template>
  <!-- component -->
  <div id="tech" class='flex min-h-screen items-center justify-center px-[5rem]'>
    <div class="container mx-auto">
        ...
        <div class="mt-8 grid grid-cols-2 gap-6 md:grid-cols-4" id="frameworks-integration">
          <!-- html -->
        <span class="group grid transition duration-700 w-full min-w-[7rem] transform place-items-center rounded-xl border border-blue-gray-50 bg-white shadow-lg sm:rounded-3xl hover:border-cyan-400 bg-clip-padding bg-opacity-55 hover:shadow-cyan-400 px-3 py-2 hover:scale-105 hover:border-blue-gray-100 hover:bg-blue-gray-50 hover:bg-opacity-25">
