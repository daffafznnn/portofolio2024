  ...
  <div id="tech" class='flex min-h-screen items-center justify-center px-[5rem]'>
    <div class="container mx-auto">
        ...
        <div class="mt-8 grid grid-cols-2 gap-6 md:grid-cols-4" id="frameworks-integration">
          <!-- html -->
        <span class="grid w-full min-w-[7rem] transform place-items-center rounded-xl border border-blue-gray-50 bg-white px-3 py-2 transition-all hover:scale-105 hover:border-blue-gray-100 hover:bg-blue-gray-50 hover:bg-opacity-25">
        ...
        <!-- javascript -->
         <span class="grid w-full min-w-[7rem] transform place-items-center rounded-xl border border-blue-gray-50 bg-white px-3 py-2 transition-all hover:scale-105 hover:border-blue-gray-100 hover:bg-blue-gray-50 hover:bg-opacity-25">
            <span class="my-6 grid h-24 w-24 place-items-center">
           <svg width="90" height="90" viewBox="0 0 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
            <g>
        ...
        <!-- boostrap -->
                <span class="grid w-full min-w-[7rem] transform place-items-center rounded-xl border border-blue-gray-50 bg-white px-3 py-2 transition-all hover:scale-105 hover:border-blue-gray-100 hover:bg-blue-gray-50 hover:bg-opacity-25">
            <span class="my-6 grid h-24 w-24 place-items-center">
          <svg width="90" height="90" viewBox="0 0 256 256" version="1.1"
        ...
        <!-- node js -->
         ...
         <span class="grid w-full min-w-[7rem] transform place-items-center rounded-xl border border-blue-gray-50 bg-white px-3 py-2 transition-all hover:scale-105 hover:border-blue-gray-100 hover:bg-blue-gray-50 hover:bg-opacity-25">
            <span class="my-6 grid h-24 w-24 place-items-center">
           <img src="https://upload.wikimedia.org/wikipedia/commons/d/d9/Node.js_logo.svg" alt="Node.js logo.svg" height="361" width="590">
            </span>
        </span>
        <!-- vite -->
        <span class="grid w-full min-w-[7rem] transform place-items-center rounded-xl border border-blue-gray-50 bg-white px-3 py-2 transition-all hover:scale-105 hover:border-blue-gray-100 hover:bg-blue-gray-50 hover:bg-opacity-25">
        ...
        <span class="grid w-full min-w-[7rem] transform place-items-center rounded-xl border border-blue-gray-50 bg-white px-3 py-2 transition-all hover:scale-105 hover:border-blue-gray-100 hover:bg-blue-gray-50 hover:bg-opacity-25">
            <span class="my-6 grid h-24 w-24 place-items-center">
          <svg width="90" height="90" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve">
        ...
        <!-- mysql -->
         <span class="grid w-full min-w-[7rem] transform place-items-center rounded-xl border border-blue-gray-50 bg-white px-3 py-2 transition-all hover:scale-105 hover:border-blue-gray-100 hover:bg-blue-gray-50 hover:bg-opacity-25">
            <span class="my-6 grid h-24 w-24 place-items-center">
           <svg width="120" height="120" viewBox="-18.458 -22.75 191.151 191.151" class="-mt-4 -mx-2"
            ...
            <path
              ...
              fill="#f8981d" />
                 ...
                 <span class="grid w-full min-w-[7rem] transform place-items-center rounded-xl border border-blue-gray-50 bg-white px-3 py-2 transition-all hover:scale-105 hover:border-blue-gray-100 hover:bg-blue-gray-50 hover:bg-opacity-25">
            <span class="my-6 grid h-24 w-24 place-items-center">
              <img src="https://www.vectorlogo.zone/logos/mongodb/mongodb-ar21.svg" alt="" srcset="" class="w-[30rem] h-[5rem]">
            </span>
        </span>
                         <span class="grid w-full min-w-[7rem] transform place-items-center rounded-xl border border-blue-gray-50 bg-white px-3 py-2 transition-all hover:scale-105 hover:border-blue-gray-100 hover:bg-blue-gray-50 hover:bg-opacity-25">
            <span class="my-6 grid h-24 w-24 place-items-center">
              <img src="https://www.vectorlogo.zone/logos/postgresql/postgresql-ar21.svg" alt="" srcset="" class="w-[35rem] h-[5rem]">
            </span>
        </span>
        </div>
    </div>
