        ...
        <div class="max-w-sm w-full">
            ...
            <div class="border border-collapse border-gray-400 shadow-md rounded-3xl p-8 ">
                ...
                <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">
                    Login Absensi
                    <p class="text-lg">admin DaffaFznnn</p>
                </h2>
                    ...
                    <div class="rounded-md shadow-sm -space-y-px">
                        <div class="my-4">
                            ...
                            <input id="email" name="email" type="email" autocomplete="email" required
                                ...
                                placeholder="Email address" v-model="dataLogin.email">
                        </div>
                        <div>
                            ...
                            <input id="password" name="password" type="password" autocomplete="current-password" required
                                ...
                                placeholder="Password" v-model="dataLogin.password">
                        </div>
                    </div>
        ...
        async performLogin() {
            ...
            try {
                ...
                if (success && this.isAuthenticated) {
                    ...
                    // Tambahkan logika untuk mengingat pengguna
                    if (this.$refs.rememberMe.checked) {
                        // Simpan informasi pengguna di local storage
                        localStorage.setItem('rememberMe', true);
                        localStorage.setItem('userEmail', this.dataLogin.email);
                    } else {
